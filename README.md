...
- запустить скрипт командами ./main.sh или bash main.sh
- в диалоговом окне указать относительный путь до директорий
- если выходная директория не пустая, скрипт будет накапливать файлы в ней, а не чистить её перед копированием
